...
public class RetrofitService {
     ...
     * 新验证码
     */
    public Call<SendLoginMessage> sendLoginMessage(String mobile) {
        return retrofitInterface.sendLoginMessage(mobile);
    }
    /**
     *   新注册登录
     *    mobile,indentiy, vcode
     根据操作不同选填： jointype ，joinid , subjoinid, nickname, faceurl , sex , plat , pushid

     */
    public Call<RegisterLoginBind> registerLoginBind(String mobile, int indentiy, String vcode,
                                                     int jointype, String joinid,String subjoinid,String nickname, String faceurl, String sex ,String plat, String pushid) {
        return retrofitInterface.registerLoginBind(mobile, indentiy, vcode,  jointype, joinid, subjoinid,nickname, faceurl, sex,plat,pushid);
    }
    /**
     * 绑定验证
     */
    public Call<GetUserBindInfo> getUserBindInfo(String token) {
        return retrofitInterface.getUserBindInfo(token);
    }
    /**
     *   新绑定
     */
    public Call<UserBind> userBind(String token, int jointype, String joinid,String subjoinid) {
        return retrofitInterface.userBind(token,jointype, joinid, subjoinid);
    }
    /**
     *   服务费
     */
    public Call<ServiceMoney> getServiceMoney(String price) {
        return retrofitInterface.getServiceMoney(price);
    }
}
