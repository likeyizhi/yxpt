...
public class UserReturnOrderList {
    /**"status": 0,
     "mes": "操作成功",
     "count": 1,
     "total": "2.00",
    ...
    private List<UserReturnOrderListlist> list;
    ...
    public List<UserReturnOrderListlist> getList() {
        return list;
    }

    public void setList(List<UserReturnOrderListlist> list) {
        this.list = list;
    }

    public static class UserReturnOrderListlist{
        /**"NOID": "10",
         "NickName": " 张立武",
