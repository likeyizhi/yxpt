...
public class MyOrderReturnInfo {
    /**"status": 0,
     "mes": "操作成功",
     "List": []*/
    private int status;
    private String mes;
    private java.util.List<MyOrderReturnInfoList> List;
    ...
    public java.util.List<MyOrderReturnInfoList> getList() {
        return List;
    }

    public void setList(java.util.List<MyOrderReturnInfoList> list) {
        List = list;
    }
