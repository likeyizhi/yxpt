...
public class RoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shopX=getIntent().getExtras().getDouble("shopX");
        shopY=getIntent().getExtras().getDouble("shopY");
        mCurrentLat=getIntent().getExtras().getDouble("mCurrentLat");
        mCurrentLon=getIntent().getExtras().getDouble("mCurrentLon");
        mCurrentCity=getIntent().getExtras().getString("mCurrentCity");
        ...
        enNode = PlanNode.withLocation(new LatLng(shopY,shopX));
...
//        PlanNode enNode = PlanNode.withLocation(new LatLng(shopY,shopX));
